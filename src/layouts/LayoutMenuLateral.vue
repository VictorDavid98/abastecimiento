  ...
  <q-layout view="hHh Lpr lff">
    ...
    >
      <q-scroll-area class="fit back-orange">
        ...
        <q-tabs v-for="item in menus" :key="item">
          <q-item clickable v-ripple class="spm">
            <q-btn-dropdown
              ...
              align="between"
            >
              <q-item clickable v-close-popup class="navChildren">
                <q-item-section class="navChildren">
                  <q-tabs
                    v-for="item in menu_childrens"
                    :key="item"
                    inline-label
                  >
                    <q-route-tab
        ...
        <q-item clickable v-ripple class="separacion spm">
